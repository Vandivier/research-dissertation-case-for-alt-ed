...
- not sure if it's true, but it would be nice for adoption and communication if it turns out that an alternative path's success rate is roughly equal to a degree's graduation rate or a college's graduation rate. Also nice if we could show an exam's pass rate, such as CLEP or w/e, after 1 or 2 attempts is about equal or better than the related course's pass rate. Finally, if we could say "if you take 4-6 exams over the course of 4-6 months, you are likely to end up with 3-4+ exams passed, which is about equal to the credit the average student gets from a semester of class anyway." Particular interest in the freshmen flunk out in the traditional vs alternative system.
...
*** Disrupting Class, Clayton and Horn ***

In chapter 1 Clayton rules out a large number of potential explanations for the inefficiency of the school system. This book is Focused on the US in particular. He distinguishes intrinsic an extra is it motivation, and identifies financial resources as an extra and Zach motivationIn chapter 2 he Calls for personalized learning with software as an important delivery vehicle. He notes the incentive to standardize education clashes with the need to personalize education. While reviewing the rest of the book in chapter 1, Clayton foreshadows that a key route toward educational innovation is to have a new technology compete against non-consumption. The result is that preferred technologies will flourish, but this natural selection of innovative technologies as opposed to an official technologies can never happen if these new technologies are not tested against non-consumption. In some sense this is true of an Exceller rated degree plan. It’s true that an Excelerator degree plan competes against a standard degree plan, but for some consumers the standard degree plan is frankly out of reach. In those situations the alternative or accelerated degree plan is the only option and it therefore does compete against non-consumption. This makes this approach to education technically innovative. Clayton identifies this innovative technology or something like it, and expects or forecasts or estimates the development of an entire new education industry on the basis of this in novation innovation. I think that’s exactly what we have seen when we look at you Dash city and other similar stories. So he seems pretty well like corroborated by the empirical evidence.Better I would say than some of the other authors authors such as Robinson, where I’m not sure if the Tivitt he has worn out such magnificent results as were expectedCreativity born out
In chapter 2 Clayton argues convincingly that one way to improve efficiency in schools is through the use of personalized education. He associates personalized or customized education with a modular administration architecture. Without having read Clayton‘s chapter and simply discussing the term modular, and analyst might believe that today’s education system is already modular. That’s because it is to a certain degree. However, after reading Clayton we realize that what he has in mind is a much more fine-grained modular approach with smaller modules. For Clayton, a modular architecture includes sub modules at the course level. The way that the accelerated degree plan that I’m working on looks appears modular at the course level, but not at the sub modular or I’m sorry sub course level. So really, what Clayton has in mind here is something like what kind academy does. This is still considered innovative even by today standards. This is not something
The end of chapter 2 is an interesting discussion of the room versus magnetic attraction reverse magnetic attraction of multiple intelligence types. Similar intelligence types attract each other rather than replacing each other. This is interesting for two reasons. First of all Clayton convincingly argues that this reverse magnetic principal holds and very into whether one actually believes the theory of multiple intelligences or not. You could just as easily substitute still heterogeneity for intelligence heterogeneity. That is people learn and Act most effectively in different ways according to different processes in different scale groups, whether or not those are attributable to diverse intelligences or simply difference is an experience or something else. The second reason this discussion is powerfully interesting is because he deflates the distinction between talent and preference. Instead, he effectively argues that people with a specific set of talents have a nurse or move with those peoples interests. This is interesting because it overcomes the objection to alternative learning from preference. Basically, if we can demonstrate that a student will be effective at alternative learning, we should assume they will also be interested in alternative learning. Naturally there will be some deviation from this pattern, but it is apparently a rare or Mine are a fact according to Clayton and those of his style of thinking. Another interesting point, although it’s tangential to my own interests, is that Clayton’s principle of reverse magnetic attraction according to thinking style is consistent with that over in theory Garrett Jones oh ring theory because it explains how clicks emerge in which thoughts and languages and practices are all consistent to the exclusion of other groups
In chapter 1, chapter 2, and throughout the book, it’s amazing to see how wrongheaded Clayton’s critics have been. Clayton maintains that schools have historically accommodated disruption. He does not argue that another industry is going to displace schools. Rather, he argues that schools can adapt to leverage disruptive technologies, and that they have done so in the past such as with the advent of computers and so on. So it is a complete misnomer that online classes will displace the university for example asKaplan portrays cartoonishly at the end of this book against education. Instead, Clayton and the disruption school has been arguing from the beginning that schools will likely indeed almost certainly is to some degree adapt in accordance with this disruption technologies. So basically Clayton is very well corroborated by history as it turns out that schools are accommodating these alternative learning methods today. Far from the robustness of University institutions being a counter argument against Clayton and the disruptors, it in deed reinforces in vindicates the prescience of Clayton and his ilk. This should serve to reinforce positively our prayers and the confidence of their predictions overtime in including today.
One issue I have with Clayton is that he takes the idea of competing with nonconsumption too far. It’s a useful way of thinking because it makes it obvious that they would be preferred to be windy is non-consumption and eggs consumption of a desired good, but although this is an obvious case a preference it is not the only case in which disruption can Floreis. Specifically, when we look at today’s market and we see hybrid models of alternative learning online, what we noticed is that many of these are cheaper and faster in the words of Ryan Craig alternatives to university, but they are not alternatives to non-consumption. That is we need to realize that the disruption we are seeing Has only something to do with competition against non-consumption, and really it is mostly competition against expensive consumption. I don’t say this to contradict or we can Clayton, but rather to strengthen his point. Indeed his paradigm of disruption is not critically dependent on the requirement of non-consumption. It is simply at its most potent in that case. But disruption can take place anyway against arbitrarily but not infinitely expensive existing systems. Clayton himself makes this point through anecdote in early chapter 5. A young girl wants to study Arabic now, not two years from now. This is exactly what I’m talking about it’s a case where you are not competing against nonconsumption in a certain sense, although you could argue that you are also competing at Gadsten to us and us in a different sense. You might just as well say that the girls time preference is the constraint you’re arguing against. In that case it’s merely a matter of preference not a matter of possibility or impossibility. Same with the budget constraint, when we talk about cheaper alternatives you could say that for some marginal group being cheaper is the difference between being able to afford it all and not being able to afford it At all. That’s true, but the marginal group does not make up the main consumer in most scenarios except for perhaps an infinite an infant industry. In many cases the consumer would have consumed anyway but they will prefer this new product because it’s cheaper or not because it’s the only one they can afford.
In chapter 5 Clayton notes that disruptive innovation’s move on economies of a log linear scale. Apparently this is a straightforward technique to estimate the timing of the S curves for stuff like this. So we can run those same numbers if we want to estimate the timing of nontraditional learning overtaking traditional learning. Clayton applies this S-curve linearization and uses enrollment as the Y axis variable of course with time being on the X axis. So it doesn’t need to be anything confusing like say the share of enrollment or anything like that or financial things which may be hard to find you can simply use enrollment. I’m not sure Ryan Craig use this S-curve disruption logic in his book about Faster cheaper you. This also may contradict Kaplan who brings up the norms issue. Because this will show that historically it happens all the time that something abnormal normalizes and in a fairly predictable fashion. So even though alternative learning maybe abnormal today, it’s not unique or is it compared to these other innovations. It could be a hypothesis that it’s unique compared to those in at visions innovations, but if the linear out a little if the linear S-curve relation exist then it basically refutes Kaplan’s idea that education is
Unique compared to these other innovations for reasons of the demand for social norms. Clayton did this forecasting for us in estimated that roughly 50% of courses will be delivered on line by 2019. Did his prediction pan out? Also what was his confidence interval on that estimate.


*** end disrupting class ***
