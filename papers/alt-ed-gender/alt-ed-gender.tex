...
Specifically, favor_programming_career, favor_seeking_risk, firm_size, hirability, is_prefer_college_peer
...
Specifically, likelihood to work in information technology, grit, and covid_impact
...
1. no diff in means for hirability nor favor_programming_career using max (skewed w/ non-serious) or min samples (deskewed, serious, and has favor_programming_career)
