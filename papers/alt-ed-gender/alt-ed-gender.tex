...
\begin{frontmatter}
    ...
    \begin{keyword}
        labor economics, alternative education, coding bootcamps, gender equity, debt crisis, student debt, education economics %%% not grammatical
...
Leave-one-out cross-validation is used to tune the elastic net and terminate the SFS process\footnote{
    % ref: sklearn.linear_model.ElasticNetCV
...
% TODO: does this block provide evidence that female openness dominates risk aversion?
...
% TODO: explanatory power by factor group
% TODO: Did prestige differ by gender
% TODO: Does time value or value of money differ by gender? -> it appears the answer is yes based on enrollment by course length
...
% not because they drop out disproportionately[29].
...
% Gender diversity in the United States is better than international gender diversity
