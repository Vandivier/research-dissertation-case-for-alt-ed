...
A survey of software developers from Stack Overflow adds a nuance to the relationship between programming and things-oriented work.
...
1. result that risk aversion and naive preference for a programming career no mean diff by gender
