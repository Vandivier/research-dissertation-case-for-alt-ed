...
\linenumbers
    ...
    NCES data is the nominal average tuition and required fees for full-time undergraduate students across all degree-granting postsecondary institutions.
    ...
    Loan data is the last key element of the analysis.
    % TODO: why do we are about loan data? discuss    
    ...
    \footnote{
     ...
     data % TODO: cite it and what does it stand for?
