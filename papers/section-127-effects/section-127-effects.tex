...
\begin{frontmatter}
    ...
    \begin{abstract}
        ...
        % Economics of Education Review maximum, 150
...
\begin{table}
    ...
    \begin{tabularx}{\textwidth}{X}
        \centering
        \input{../section-127-effects/figures-and-tables/table-2.tex}
    \end{tabularx}
...
These results indicate that the apparent autocorrelation is due to independent effects,
including unobserved effects, which are effectively proxied by time.
...
In the three-variable specification, the r-squared for the visa variable is greater than 0.913,
...
After correcting for a wide set of relevant data, the effect of Section 127 does appear to be negative on total enrollment over the period from 1992 to 2016.
The within-period marginal effect of increasing Section 127 assistance is positive.
Vector autoregression indicates that using this kind of assistance as a policy tool is relatively unlikely to impact enrollment in a meaningful way.

Analysis indicates that the H-1B policy is a relatively strong policy tool.
A positive shock to the count of H-1B visas issued is associated with increases in enrollment, total loans, and the price of education.
...
There are important distributional effects, but they appear to be desirable overall.
The main effects of increased H-1B labor involve a transfer of wealth from native computer scientists to all other people.
...
First, allow for the deduction of alternative education costs instead of requiring such funds to be used for college.
...
The second change would be a modification of the employer requirement.
The modification would allow an individual to take a deduction for themselves or a dependent.
...
Many students work full time while attending college, but many do not.
Allowing an individual to take a deduction for themselves or their dependent would encourage increased education among impoverished groups
relative to those individuals who are already employed.
