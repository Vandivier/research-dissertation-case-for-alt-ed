...
\begin{frontmatter}
    ...
    \begin{abstract}
        ...
        Section 127 of the United States Internal Revenue Code provides a tax deduction to employers that provide financial assistance for employee education.
        This policy was intended as a positive incentive on enrollment in higher education.
        This paper finds that before and after taking extensive steps to account for important dynamic factors,
        the policy fails to meaningfully increase enrollment.
        ...
        Negative linear and total effects are observed over the period of analysis from 1992 through 2017.
        ...
        H-1B policy is explored as a correction variable, but emerges as a comparatively preferred policy tool.
