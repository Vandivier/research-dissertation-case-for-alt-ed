...
\begin{abstract}
    ...
    % the results show that a positive shock to EPU triggers a negative response from BFI, RE, FIN and PAT in the short-run.
    % In addition, I find that higher levels of EPU significantly decrease BFI, RE and FIN in the long-run.
