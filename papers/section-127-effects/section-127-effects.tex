...
\linenumbers
    ...
    The total effect in the relevant range is also positive.
    ...
    H-1 visa effects are significant and complex across specification.
    ...
    Time is also highly significant across multiple regressive models.
    The signficance of time motivates checking additional specifications
    including a dynamic ordinary least squares
    and a vector autoregressive model.
