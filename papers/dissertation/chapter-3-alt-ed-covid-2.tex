...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[element/.style={minimum width=1.75cm, minimum height=0.85cm}]
        ...
        \node (n3) [above=0.25cm] at ($(n1)!0.5!(n1) - (1, 5.5)$) {\textbf{Favorability}};
    \end{tikzpicture}
...
% Table \ref{tab:desc_stats_ch3} describes summary statistics for the total sample and also distinctly describes three subsamples.
