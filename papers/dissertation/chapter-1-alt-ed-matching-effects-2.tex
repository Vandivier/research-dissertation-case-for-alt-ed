...
\chapter[Conformity and Soft Skills as Determinants of Alternatively Credentialed Non-College Graduate Hirability]{\large Conformity and Soft Skills as Determinants of Alternatively Credentialed Non-College Graduate Hirability}
...
\begin{figure}[h!]
    ...
    \begin{tikzpicture}[element/.style={minimum width=1.75cm, minimum height=0.85cm}]
        ...
        \node (n2) [above=0.25cm] at ($(n1)!0.5!(n1) - (7, 0)$) {\textbf{Density}};
        \node (n3) [above=0.25cm] at ($(n1)!0.5!(n1) - (0, 5.5)$) {\textbf{Discretized Firm Size}};
    \end{tikzpicture}
    \label{fig:firm_size}
\end{figure}
