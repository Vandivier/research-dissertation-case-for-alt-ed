...
\begin{abstract}
    ...
    has survived disillusionment and is becoming a sustained economic institution.
...
\linenumbers
    ...
    \begin{figure}[h!]
        ...
        \node (n1) [above=0.25cm] {\includegraphics[width=1\textwidth]{../student-debt-history/figures-and-tables/google-trends-digital-education.png}};
        \end{tikzpicture}
    ...
    \begin{figure}[h!]
        ...
        \begin{tikzpicture}[element/.style={minimum width=1cm, minimum height=0.75cm}]
        \node (n1) [above=0.25cm] {\includegraphics[width=1\textwidth]{../student-debt-history/figures-and-tables/google-search-wgu.png}};
        \end{tikzpicture}
