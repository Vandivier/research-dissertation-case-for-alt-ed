...
and the two causality questions.
...
A large perceived impact from coronavirus is not reported by any individual for whom a negative outlier response on favorability is observed.
In contrast, the Tens report a large perceived impact at a disproportionately high rate.
This is important when conclusions about the American population are drawn from the discussion on coronavirus impact.

This data is consistent with external reporting that most Americans are impacted by COVID-19\cite{demographic2020},
...
Notice that the negative outlier group has the highest affirmative response with respect to both a
...
so this group is sometimes seen as a guard of the traditional degree or an opponent of alternative education. % TODO: citation
