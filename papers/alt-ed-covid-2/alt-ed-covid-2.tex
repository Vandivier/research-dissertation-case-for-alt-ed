...
% TODO: mere exposure: https://pubmed.ncbi.nlm.nih.gov/15974346/
...
specified using an ordinary linear model or a robust linear model (RLM).
...
and 11 outliers are idenfitied in the sample.
