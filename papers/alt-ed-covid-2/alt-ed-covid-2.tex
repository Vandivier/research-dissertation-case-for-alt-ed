...
One paper in the Journal of School Choice examined educational experiences of families under COVID-19\cite{carpenter2020we}.
...
The magnitude of perceived impact is another case where outliers and Tens importantly differ from the average.
...
This study seperately demonstrates a positive relationship between favorability to remote learning
...
results in an increase to favorability of alternative credentials.
...
A relatively small improvement for most respondents makes sense given that the median response is already near the maximum response.
...
leading some scholars argue that higher education is an instrument of white supremacy\cite{hikido2016whitened, dennis2001skillful}.
Other scholars note that alternative institutions support a higher rate of minority graduation,
and as a result the support for alternative credentials is considered a workforce diversity strategy\cite{brown2017complex, jones2018alternative, rossiter2019designing}.
...
This industry is fundamentally connected to the web and is unique in the high rate of obsolescence of dated learning.
...
% The effect is not direct, as if an individual severely struck by illness would immediately opens their mind to new modes of learning.
...
% There are a variety of self-reinforcing effects which kick in once new norms are established.
% These effects make change prohibatively costly for many agents in the economy.
...
they did advocate for removing accreditation agencies and suggested the government should directly accredit courses rather than organizations. % TODO: cite https://www.americanprogress.org/issues/education-postsecondary/reports/2019/04/18/468840/trump-administration-undoing-college-accreditation/
