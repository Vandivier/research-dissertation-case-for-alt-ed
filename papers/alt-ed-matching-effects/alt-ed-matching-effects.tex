...
% Technically, hirability is equally a proxy for $w_{ij}$ and $E_i(MRP_j)$ and more...but let's not get off topic and confuse the reader...
...
% The unit of factor coefficients for rulebreakers and skill gaps is hirability per Likert-type unit, where hirability is also a Likert-type unit.
...
Table \ref{tab:gap_of_gaps}

\begin{table}
    \caption{Multiple Regression of Comparative Skill Gap on ACNG Hirability}
    \resizebox{\columnwidth}{!}{
        \input{./figures-and-tables/table-1-massaged.tex}
    }
...
TODO: talk about google discarding degree and creating an alternative credential as an example that major corps, esp IT, could be first to mark this trend but not last under temporal analysis
