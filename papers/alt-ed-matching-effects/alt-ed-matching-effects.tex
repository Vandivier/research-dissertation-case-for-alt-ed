...
\begin{frontmatter}
    ...
    \begin{keyword}
        education economics, signaling, alternative education, conformity, vocational               %%% not grammatical
...
This paper seeks to resolve the apparent discrepancy between these outcomes while preserving the mainline view that employers pay for perceived job candidate skill.
...
This paper focuses on the comparatively interesting case of alternative credentials as a substitute for the college degree in order to diagnose comparative disadvantage at the skill level.
...
Signaling theory provides three advantages over human capital theory for the purposes of the present study.
First, signaling theory is able to explain labor outcome variance when human capital is held constant.
...
According to the signaling model, labor demand is formed on the basis of job candidate value as perceived by an employer.
...
Nontraditional courses can be completed in a shorter span of time and with reduced entry qualifications relative to the traditional degree.
For this reason, alternative credentials are thought to signal low conscientiousness relative to the college degree.
...
Research indicates the existence of bliss points for employee conscientiousness and conformity from the point of view of an employer.
...
This makes hireability a proxy of demand for labor and $w_{ij}$.
...
Comparative analysis provides additional confidence in the data by replicating the hireability gap between ACNG labor and recent college graduates reported in external research.
...
suggests that the effect of employer status on hireability critically interacts with industry,
...
Secondly, a gap in perceived nonconformity skill yields a negative coefficient on hireability.
...
The negative coefficient for nonconformity therefore indicates that a reduction to nonconformity is associated with reduced hireability.
Similarly, an increase to the level of perceived nonconformity shrinks the gap size and produces a positive change in hireability.
% Similarly, an increase to the level of perceived nonconformity shrinks the gap size and produces a reduced negative effect on hireability.
...
The third reason that an ACNG nonconformity signal does not explain reduced hireability is that the ACNG and recent college graduate do not significantly differ in perceived levels of conformity.
...
% In theory, a person that is high in conscientiousness will tend not to break rules.
%
% coefficient basically positive by coincidence, then...
% in other words, I'm hypothesizing negative embedded conscientiousness effects in the cross-correlated factors.
% It could be the case that conscientiousness is a composite of positive and negative variation.
% It could be the case that these cross-correlates partial out a substantial degree of the negative variation in conscientiousness,
...
The largest category of employer is positively associated with hireability.
...
Body language skill gaps on their are associated with reduced hireability.
...
Table \ref{tab:gap_of_gaps} provides two models of hireability where comparative skill gaps are the independent factors.
...
%
Alternatively educated individuals can offset perceived conscientiousness deficit by provisioning work history or results of a personality test.
...
Perceived skill gaps do a better job of explaining hireability than do other widely recognized effects including industry and state effects.
...
The present paper finds evidence that conscientiousness is an important comparative difference which contributes to weak ACNG demand,
