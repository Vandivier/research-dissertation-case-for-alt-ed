...
% it's curvilinear! http://www.philender.com/courses/linearmodels/notes3/curve.html
...
% MAYBE TODO: show figure for `tab isideal*' or a correlation matrix
% or `scatter concientiousness_ngwac concientiousness_recent'
% or `tab concientiousness_ngwac concientiousness_recent'
% but average comparison gets at it too (`sum concientiousness_ngwac concientiousness_recent con*ideal')
% ref: `sum bodylanguage_ngwac bodylanguage_recentcollegegradua bodylanguage_ideal'
% MAYBE TODO: heatmap https://fmwww.bc.edu/repec/dsug2019/germany19_jann.pdf
% or correlation table https://lost-stats.github.io/Presentation/heatmap_colored_correlation_matrix.html#stata
...
Willingness to commute follows a similar pattern. % of dispersion
...
% This makes the negative coefficient for the comparative marginal effect intuitive.
Negative comparative marginal effects indicate that hirability increases as comparative gaps decrease.

% The converse is that as comparative gaps increase, hirability decreases.
Negative marginal effects also indicate that hirability decreases as comparative gaps increase.
% This is also made intuitive by the summary statistics on average perceived skill levels.
...
% TODO: footnote and compute above statement.
