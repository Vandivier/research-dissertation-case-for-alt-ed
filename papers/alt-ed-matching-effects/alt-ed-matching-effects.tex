...
% general questions?
% ---
% 1. favorability toward alternative education
%      a. could randomize whether this question appears first or last to test for framing, cognitive engagement, or cognitive exhaustion.
% 2. normal salary for a new hire
% 3. job title
% 4. Are you aware of any alternative credentials for this job title?
% 5. industry / STEM question
% 6. firm size effects (principal-agent)
% 7. certification or degree required by law, required by corporate policy, not required
% 8. gender
...
% 9. how long do you think it takes to get an alternative credential?
% 10. organizational constraint / hireability concern / organizational agility - I may like these candidates but i can't hire them due to inflexibly company or legal policy.
% 11. broad hiring: I hire for a particular role vs I hire for many roles
% 12. state of residence
% 13. I find it hard to find a good employee
%       a. employers with high need should be willing to accept lower quality.
%       b. however, I expect need is largely captured in wages + industrial + state effects
...
% quality question prompts
% ---
% 1. technical skills
% 2. conformity
%    a. nonconformity as anti-social behavior, soft skill deficit, and/or productivity risk.
%    b. nonconformity as an awesomeness signal. duel-weirdness theory.
%    c. nonconformity as culture add, creativity, or innovation.
% 3. attractiveness (marketing industry effect?)
% 4. concientiousness (or could be more direct "show up to meetings on time")
% 5. anti-social: gets along well with others (or more concrete)
% 6. written communication skill
% 7. verbal communication skill
% 8. informal communication skill (ie body language, intonation, and subtext/connotation apprehension; nonwritten and nonverbal)
% 9. requires flex hours / on call at any time. schedule-constrained.
% 10. lower wages
% 12. will have issues with commuting to work or for work (ie, poor fit for food delivery or commercial trucking job).
