...
% could be \section{Introduction and Description of Data}
...
% why positive coefficient on work ethic? 3 theories:
% 1. it's an attenuation for a negative halo effect which obtains when respondent proposes a large gap
%    a. that is, the respondent disproportionately penalizes all other skills when concientiousness is low, but still is favorable to hiring.
%    b. supporting evidence: coefficient in simple regression is negative (but also insignificant 0.5 < p < 0.55)
%    c. more supporting evidence: coefficient is negative and of nontrivial signifiance if all other skill gaps are dropped (p < 0.31)
%    d. specific attenuation for a subset of rulebreakers* plus a specific set of skills: aetiwno_bodylanguage aetiwno_commute aetiwno_concientiousness aetiwno_customerserviceskill aetiwno_technicaljobskills
% note: work ethic gap is usually less than three
% note: doesn't explain college hireability differential very much bc new college grads are taken to have about the same level of concientiousness (7.14 vs 7.11 mean response; sigma 1.87 vs 1.85)
% 2. i measured that gap wrong; false - verified computation is as expected in do file
% 3. it's part of a desirable bundle; they really are viewed as lower work ethic but they have offsetting benefits elsewhere, eg creativity
%   a. not really plausible bc every other study says work ethic is of general importance; no cases of "it's good to be low in work ethic" are known
%   b. maybe offsetting good is salary?
% also discuss the interaction effects and firm size effects...

TODO: it's a problem that there's a negative coefficient on work ethic

https://onlinelibrary.wiley.com/doi/10.1002/ijop.12511
"conscientiousness have inverted U‐shaped relationships with contributions to teamwork"

1. attenuate negative halo
2. low concientiousness could indicate good social skills / culture fit (don't be a workaholic type of thing)
3. table of cross correlation for model 5; also note that college grads have insignificantly different, so importance of concientiousness doesn't feed signal theory

% TODO:
% 1. what is the preferred model and why?
% 2. employer size also matters, adding more to the risk theory
% 3. this implies skills matter, but which ones?
% 4. one of them is concientiousness, so we see the signal theorist hypothesis isn't totally invalidated, only partially; concientiousness is generally good while conformity is only contextually good.
% 5. industrial effects and state effects matter; policy may be a thing here; further research needed
% 6. conclusion:
%    a. repeat: industrial effects and state effects matter; policy may be a thing here; further research needed
%    b. point out that a bunch of the variance still isn't explained; refer to my other paper perhaps for other factors that matter
%    c. point out that employer perception is often wrong, eg w respect to technical skill: next steps to rectify?
...
dynamic reanalysis is important as these perceptions by skill may change over time; specifically, the normative status of education changes over time; accredited system once was abnormal (but good-weird, indicative of high performers)
