...
The average actual employee has a higher level of perceived nonconformity than either the ACNG or the recent college graduate.
...
Removing factors for skill gaps and rulebreaker effects from Model 5 tests this hypotheis.
...
These two measures allow computation of a conservative lower-bound on the explanatory ratio of perceived skill gaps to state effects.
...
This negative total effect replicates external research that shows lower demand for ACNG labor.
...
For body language communication skills, the recent college graduate has the larger level of perceived skill on average.
