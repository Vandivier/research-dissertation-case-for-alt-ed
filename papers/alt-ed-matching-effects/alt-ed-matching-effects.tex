...
In order to explain the reduced willingness to pay for ACNG labor relative to college graduate labor,
...
These variables are measured using Likert-type units.
They include hireability,
rulebreaker effects,
...
The third reason that an ACNG nonconformity signal does not explain reduced hireability is that the ACNG
and the recent college graduate do not significantly differ in perceived levels of conformity.
...
% partialled from is a thing academics say: ncbi.nlm.nih.gov/pmc/articles/PMC3152746/
% i think 'partialled from' is kind of an awkward tense...but it's what the other academics say, so...
