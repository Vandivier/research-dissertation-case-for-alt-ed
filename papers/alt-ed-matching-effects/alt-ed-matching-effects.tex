...
If large employers are favorable to the ACNG, this will add weight to an explanation based on risk aversion.
...
The technical skill gap is insignificant, but it is robust in sign across models and it does possess the expected negative sign.
