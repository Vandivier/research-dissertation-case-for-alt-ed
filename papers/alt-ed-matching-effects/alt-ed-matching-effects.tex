...
\begin{frontmatter}
    ...
    \begin{abstract}
        ...
        % perceived skill gaps mainly soft skills like `smart, conscientious and conformist'
...
% Real-world hiring decisions reflect boundedly rational decisions on the part of a hiring team.
% Candidate matching is a subsidiary of the hiring process.
% A hiring team makes certain observations about an applicant and decides whether the candidate is a fit for an available job.
% College degree requirements for many occupations exist.
