...
\begin{frontmatter}
    ...
    \begin{abstract}
        ...
        % example/template abstract ref: https://www.emerald.com/insight/content/doi/10.1108/ET-08-2017-0120/full/html
...
Experts view many alternatives to college, such as vocational school, as useful for technical training, but the traditional college degree retains a wage premium over vocational education.
This paper tests the hypothesis that there is a lack of willingness to hire an alternatively credentialed non-college graduate (ACNG) which is explained by a perceived lack in certain skills.
In particular, this paper hypothesizes that ACNGs are seen as nonconformist and lacking in soft skills.
...
The signaling model has become one of the standard explanations of the value of the degree.
...
Alternative credentials do not signal work ethic or conformity, but they do indicate intelligence and technical skill. % that is, according to me...
...
This paper hypothesizes that employers infer a deficit in conformity and conscientiousness in alternatively credentialed non-college graduates (ACNG) relative to college graduates.
...
Firm innovation is attributable to underlying employee innovation, but conformity is antithetical to innovation. % TODO: cite John Nye on the advantages and disadvantages of conformity.
