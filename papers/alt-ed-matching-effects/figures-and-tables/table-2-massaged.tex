...
\begin{tabular}{l*{5}{c}}
    ...
    \multicolumn{6}{l}{\footnotesize
        ...
        % The unit of the coefficients in this table are hireability per Likert-type unit, where hireability is also a Likert-type unit.
        % In this paper, all Likert-type scales are 10-point scales.
    }                                                                                                                                                                              \\
\end{tabular}
}
