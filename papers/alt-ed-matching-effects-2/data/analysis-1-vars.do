...
label variable _isstate1 "State, Alabama"
label variable _isstate2 "State, Alaska"
label variable _isstate3 "State, Arizona"
label variable _isstate4 "State, Arkansas"
label variable _isstate5 "State, California"
label variable _isstate6 "State, Colorado"
label variable _isstate7 "State, Connecticut"
label variable _isstate8 "State, Delaware"
label variable _isstate9 "State, D.C."
label variable _isstate10 "State, Florida"
label variable _isstate11 "State, Georgia"
label variable _isstate12 "State, Hawaii"
label variable _isstate13 "State, Idaho"
label variable _isstate14 "State, Illinois"
label variable _isstate15 "State, Indiana"
* // label variable _isstateXX "State, Iowa"
label variable _isstate16 "State, Kansas"
label variable _isstate17 "State, Kentucky"
label variable _isstate18 "State, Louisiana"
label variable _isstate19 "State, Maine"
label variable _isstate20 "State, Maryland"
label variable _isstate21 "State, Massachusetts"
label variable _isstate22 "State, Michigan"
label variable _isstate23 "State, Minnesota"
label variable _isstate24 "State, Mississippi"
label variable _isstate25 "State, Missouri"
* // label variable _isstateXX "State, Montana"
label variable _isstate26 "State, Nebraska"
label variable _isstate27 "State, Nevada"
* // label variable _isstateXX "State, New Hampshire"
label variable _isstate28 "State, New Jersey"
* // label variable _isstateXX "State, New Mexico"
label variable _isstate29 "State, New York"
label variable _isstate30 "State, North Carolina"
label variable _isstate31 "State, North Dakota"
label variable _isstate32 "State, Ohio"
* // label variable _isstateXX "State, Oklahoma"
label variable _isstate33 "State, Oregon"
label variable _isstate34 "State, Pennsylvania"
label variable _isstate35 "State, Rhode Island"
label variable _isstate36 "State, South Carolina"
* // label variable _isstateXX "State, South Dakota"
label variable _isstate37 "State, Tennessee"
label variable _isstate38 "State, Texas"
label variable _isstate39 "State, Utah"
label variable _isstate40 "State, Vermont"
label variable _isstate41 "State, Virginia"
label variable _isstate42 "State, Washington"
* // label variable _isstateXX "State, West Virginia"
label variable _isstate43 "State, Wisconsin"
label variable _isstate44 "State, Wyoming"

label variable _isindustry1 "Industry, Agriculture"
label variable _isindustry2 "Industry, Education"
label variable _isindustry3 "Industry, Energy"
label variable _isindustry4 "Industry, Finance, Investment, or Accounting"
label variable _isindustry5 "Industry, Health"
label variable _isindustry6 "Industry, Information Technology"
label variable _isindustry7 "Industry, Law"
label variable _isindustry8 "Industry, Manufacturing"
label variable _isindustry9 "Industry, Military"
label variable _isindustry10 "Industry, Real Estate"
label variable _isindustry11 "Industry, Retail"
label variable _isindustry12 "Industry, Transportation"

* // ssc install labsumm, replace
